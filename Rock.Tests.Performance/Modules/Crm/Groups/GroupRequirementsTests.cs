...
namespace Rock.Tests.Performance.Crm.Groups
{
    ...
    public class GroupRequirementsTests
    {
        ...
        {
            //TestDatabaseHelper.RestoreSnapshot( "CalculateGroupRequirements" );
        ...
        {
            // Restore the default sample data database
            //TestDatabaseHelper.RestoreSnapshot( "default" );
            ...
            //TestDatabaseHelper.CreateSnapshot( "CalculateGroupRequirements", overwriteExisting: true );
        }
