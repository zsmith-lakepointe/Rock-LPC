...
namespace Rock.Blocks.Communication
{
    ...
    public partial class CommunicationEntry : RockBlockType
    {
        ...
        // 40th year anniversary invite to future get-away 4 days 3 nights
        // new orleans (12 full months (7 day notice to cancel)) property is Crown Plaza ($249 total)
        // join for a short 2-hour VIP tour
        ...
        public override object GetObsidianBlockInitialization()
        {
            ...
            var mode = GetAttributeValue( AttributeKey.Mode );
            box.CanSearchOrAddNewPeople = IsFullMode;

            // Does this mean an approved item is being edited
            // or that editing is approved?
            box.IsEditingApproved = PageParameter( PageParameterKey.Edit ).AsBoolean() && Authorization.Authorized( this.BlockCache, Authorization.APPROVE, GetCurrentPerson() );
        ...
        private void LoadTemplates()
        {
            ...
            ddlTemplate.Visible = IsFullMode && visible;
        }
