...
export const ConfigurationComponent = defineComponent({
    name: "CodeEditorField.Configuration",
    ...
    setup(props, { emit }) {
        ...
        watch(() => [props.modelValue, props.configurationProperties], () => {
            editorMode.value = props.modelValue[ConfigurationValueKey.EditorMode] ?? "Text";
            editorTheme.value = props.modelValue[ConfigurationValueKey.EditorTheme] ?? "Rock";
