...
import { ConfigurationValueKey } from "./interactionChannelsField.partial";
...
export const EditComponent = defineComponent({
    name: "InteractionChannelsField.Edit",
    ...
    setup(props, { emit }) {
        ...
        const options = computed((): ListItemBag[] => {
            const selectedChannels = JSON.parse(props.configurationValues[ConfigurationValueKey.ClientValues] || "[]") as ListItemBag[];
...
export const ConfigurationComponent = defineComponent({
    name: "InteractionChannelsField.Configuration",
