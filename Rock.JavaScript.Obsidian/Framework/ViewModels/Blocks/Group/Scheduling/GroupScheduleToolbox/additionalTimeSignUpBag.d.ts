...
import { AdditionalTimeSignUpLocationBag } from "@Obsidian/ViewModels/Blocks/Group/Scheduling/GroupScheduleToolbox/additionalTimeSignUpLocationBag";

/** A bag that contains information about an additional time sign-up for the group schedule toolbox. */
export type AdditionalTimeSignUpBag = {
    /** Gets or sets the locations available for this additional time sign-up. */
    locations?: AdditionalTimeSignUpLocationBag[] | null;
