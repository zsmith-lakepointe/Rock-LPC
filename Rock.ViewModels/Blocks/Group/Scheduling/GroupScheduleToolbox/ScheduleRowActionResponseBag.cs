...
{
    /// <summary>
    /// A bag that contains information about the outcome of a schedule row action request for the group schedule toolbox.
    /// </summary>
    public class ScheduleRowActionResponseBag
    {
        /// <summary>
